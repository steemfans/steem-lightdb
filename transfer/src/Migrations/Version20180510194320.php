 ...
 */
final class Version20180510194320 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE blocks (id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL, block_num BIGINT NOT NULL, previous VARCHAR(40) DEFAULT \'\' NOT NULL COLLATE utf8mb4_general_ci, block_id VARCHAR(40) DEFAULT \'\' NOT NULL COLLATE utf8mb4_general_ci, block_info MEDIUMTEXT NOT NULL COLLATE utf8mb4_general_ci, timestamp VARCHAR(19) DEFAULT \'\' NOT NULL COLLATE utf8mb4_general_ci, UNIQUE INDEX block_num (block_num), UNIQUE INDEX block_id (block_id), UNIQUE INDEX previous (previous), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE transactions (id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL, block_id BIGINT NOT NULL, content LONGTEXT NOT NULL COLLATE utf8mb4_general_ci, block_num BIGINT NOT NULL, INDEX block_id (block_id), INDEX block_num (block_num), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
